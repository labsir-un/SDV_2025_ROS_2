...
#include "sdv_msgs/msg/detail/imu_raw__rosidl_typesupport_fastrtps_c.h"
...
using _ImuRaw__ros_msg_type = sdv_msgs__msg__ImuRaw;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
bool cdr_serialize_sdv_msgs__msg__ImuRaw(
  const sdv_msgs__msg__ImuRaw * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
bool cdr_deserialize_sdv_msgs__msg__ImuRaw(
  eprosima::fastcdr::Cdr & cdr,
  sdv_msgs__msg__ImuRaw * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
size_t get_serialized_size_sdv_msgs__msg__ImuRaw(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
size_t max_serialized_size_sdv_msgs__msg__ImuRaw(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs__msg__ImuRaw;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
bool cdr_serialize_key_sdv_msgs__msg__ImuRaw(
  const sdv_msgs__msg__ImuRaw * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
size_t get_serialized_size_key_sdv_msgs__msg__ImuRaw(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ImuRaw__ros_msg_type * ros_message = static_cast<const _ImuRaw__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
size_t max_serialized_size_key_sdv_msgs__msg__ImuRaw(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sdv_msgs__msg__ImuRaw * ros_message = static_cast<const sdv_msgs__msg__ImuRaw *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sdv_msgs__msg__ImuRaw(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sdv_msgs__msg__ImuRaw * ros_message = static_cast<sdv_msgs__msg__ImuRaw *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sdv_msgs__msg__ImuRaw(cdr, ros_message);
}

static uint32_t _ImuRaw__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sdv_msgs__msg__ImuRaw(
...
static size_t _ImuRaw__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sdv_msgs__msg__ImuRaw(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sdv_msgs, msg, ImuRaw)() {
