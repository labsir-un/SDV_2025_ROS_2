...
#include "sdv_msgs/msg/detail/battery__rosidl_typesupport_fastrtps_c.h"
...
using _Battery__ros_msg_type = sdv_msgs__msg__Battery;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs__msg__Battery;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sdv_msgs__msg__Battery * ros_message = static_cast<const sdv_msgs__msg__Battery *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sdv_msgs__msg__Battery(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sdv_msgs__msg__Battery * ros_message = static_cast<sdv_msgs__msg__Battery *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sdv_msgs__msg__Battery(cdr, ros_message);
}

static uint32_t _Battery__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sdv_msgs__msg__Battery(
...
static size_t _Battery__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sdv_msgs__msg__Battery(
