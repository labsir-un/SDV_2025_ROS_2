...
bool cdr_serialize_sdv_msgs__msg__Encoder(
  const sdv_msgs__msg__Encoder * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
bool cdr_deserialize_sdv_msgs__msg__Encoder(
  eprosima::fastcdr::Cdr & cdr,
  sdv_msgs__msg__Encoder * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
bool cdr_serialize_key_sdv_msgs__msg__Encoder(
  const sdv_msgs__msg__Encoder * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
size_t get_serialized_size_key_sdv_msgs__msg__Encoder(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Encoder__ros_msg_type * ros_message = static_cast<const _Encoder__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_msgs
size_t max_serialized_size_key_sdv_msgs__msg__Encoder(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sdv_msgs__msg__Encoder * ros_message = static_cast<const sdv_msgs__msg__Encoder *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sdv_msgs__msg__Encoder(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sdv_msgs__msg__Encoder * ros_message = static_cast<sdv_msgs__msg__Encoder *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sdv_msgs__msg__Encoder(cdr, ros_message);
}
