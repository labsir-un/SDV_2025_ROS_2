...
#include "sdv_msgs/msg/detail/motor_driver__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // driver_status, name
#include "rosidl_runtime_c/string_functions.h"  // driver_status, name

// forward declare type support functions


using _MotorDriver__ros_msg_type = sdv_msgs__msg__MotorDriver;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->driver_status;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  sdv_msgs__msg__MotorDriver * ros_message)
{
  ...
  // Field name: driver_status
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->driver_status.data) {
      rosidl_runtime_c__String__init(&ros_message->driver_status);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->driver_status,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'driver_status'\n");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
    (ros_message->driver_status.size + 1);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs__msg__MotorDriver;
    is_plain =
      (
      offsetof(DataType, driver_status) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sdv_msgs__msg__MotorDriver * ros_message = static_cast<const sdv_msgs__msg__MotorDriver *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sdv_msgs__msg__MotorDriver(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sdv_msgs__msg__MotorDriver * ros_message = static_cast<sdv_msgs__msg__MotorDriver *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sdv_msgs__msg__MotorDriver(cdr, ros_message);
}

static uint32_t _MotorDriver__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sdv_msgs__msg__MotorDriver(
...
static size_t _MotorDriver__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sdv_msgs__msg__MotorDriver(
