...
#include "sdv_msgs/msg/detail/four_motors__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sdv_msgs::msg::FourMotors & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sdv_msgs::msg::FourMotors & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sdv_msgs
max_serialized_size_FourMotors(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs::msg::FourMotors;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sdv_msgs
max_serialized_size_key_FourMotors(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const sdv_msgs::msg::FourMotors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sdv_msgs::msg::FourMotors *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FourMotors__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sdv_msgs::msg::FourMotors *>(
...
static size_t _FourMotors__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FourMotors(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FourMotors__callbacks = {
  "sdv_msgs::msg",
  "FourMotors",
...
static rosidl_message_type_support_t _FourMotors__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FourMotors__callbacks,
...
{
  return &sdv_msgs::msg::typesupport_fastrtps_cpp::_FourMotors__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sdv_msgs, msg, FourMotors)() {
  return &sdv_msgs::msg::typesupport_fastrtps_cpp::_FourMotors__handle;
}
