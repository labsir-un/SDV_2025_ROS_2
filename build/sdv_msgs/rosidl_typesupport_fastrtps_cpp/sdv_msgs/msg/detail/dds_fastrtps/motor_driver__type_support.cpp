...
#include "sdv_msgs/msg/detail/motor_driver__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sdv_msgs::msg::MotorDriver & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sdv_msgs::msg::MotorDriver & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs::msg::MotorDriver;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sdv_msgs::msg::MotorDriver *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sdv_msgs::msg::MotorDriver *>(
    untyped_ros_message);
...
{
  return &sdv_msgs::msg::typesupport_fastrtps_cpp::_MotorDriver__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sdv_msgs, msg, MotorDriver)() {
  return &sdv_msgs::msg::typesupport_fastrtps_cpp::_MotorDriver__handle;
}
