...
#include "sdv_msgs/msg/detail/flexiforce__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_msgs::msg::Flexiforce;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sdv_msgs::msg::Flexiforce *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sdv_msgs::msg::Flexiforce *>(
    untyped_ros_message);
...
{
  return &sdv_msgs::msg::typesupport_fastrtps_cpp::_Flexiforce__handle;
}
