...
bool sdv_msgs__msg__tag_rfid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_msgs.msg._tag_rfid.TagRfid", full_classname_dest, 30) == 0);
  }
  sdv_msgs__msg__TagRfid * ros_message = _ros_message;
  {  // header
...
PyObject * sdv_msgs__msg__tag_rfid__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_msgs.msg._tag_rfid");
