...
bool sdv_msgs__msg__imu_raw__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_msgs.msg._imu_raw.ImuRaw", full_classname_dest, 28) == 0);
  }
  sdv_msgs__msg__ImuRaw * ros_message = _ros_message;
  {  // header
...
PyObject * sdv_msgs__msg__imu_raw__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_msgs.msg._imu_raw");
