...
static const _Udp_type_support_symbol_names_t _Udp_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sdv_scripts, msg, Udp)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sdv_scripts, msg, Udp)),
  }
};
...
{
  return &::sdv_scripts::msg::rosidl_typesupport_cpp::Udp_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sdv_scripts, msg, Udp)() {
  return get_message_type_support_handle<sdv_scripts::msg::Udp>();
}
