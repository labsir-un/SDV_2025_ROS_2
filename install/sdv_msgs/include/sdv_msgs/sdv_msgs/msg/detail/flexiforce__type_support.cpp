...
{
  new (message_memory) sdv_msgs::msg::Flexiforce(_init);
}

void Flexiforce_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sdv_msgs::msg::Flexiforce *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Flexiforce_message_member_array[5] = {
  {
    ...
    offsetof(sdv_msgs::msg::Flexiforce, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sdv_msgs::msg::Flexiforce, front_left),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sdv_msgs::msg::Flexiforce, front_right),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sdv_msgs::msg::Flexiforce, back_left),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sdv_msgs::msg::Flexiforce, back_right),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Flexiforce_message_members = {
  ...
  5,  // number of fields
  sizeof(sdv_msgs::msg::Flexiforce),
...
get_message_type_support_handle<sdv_msgs::msg::Flexiforce>()
{
  return &::sdv_msgs::msg::rosidl_typesupport_introspection_cpp::Flexiforce_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sdv_msgs, msg, Flexiforce)() {
  return &::sdv_msgs::msg::rosidl_typesupport_introspection_cpp::Flexiforce_message_type_support_handle;
}
