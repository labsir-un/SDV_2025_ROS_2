...
sdv_msgs__msg__Ultrasound__init(sdv_msgs__msg__Ultrasound * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    sdv_msgs__msg__Ultrasound__fini(msg);
    return false;
  }
  // sensors
...
sdv_msgs__msg__Ultrasound__create(void)
{
  ...
  sdv_msgs__msg__Ultrasound * msg = (sdv_msgs__msg__Ultrasound *)allocator.allocate(sizeof(sdv_msgs__msg__Ultrasound), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sdv_msgs__msg__Ultrasound));
  bool success = sdv_msgs__msg__Ultrasound__init(msg);
  if (!success) {
...
sdv_msgs__msg__Ultrasound__Sequence__init(sdv_msgs__msg__Ultrasound__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sdv_msgs__msg__Ultrasound * data = NULL;

  if (size) {
    data = (sdv_msgs__msg__Ultrasound *)allocator.zero_allocate(size, sizeof(sdv_msgs__msg__Ultrasound), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sdv_msgs__msg__Ultrasound__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sdv_msgs__msg__Ultrasound__fini(&data[i - 1]);
      }
...
sdv_msgs__msg__Ultrasound__Sequence__fini(sdv_msgs__msg__Ultrasound__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sdv_msgs__msg__Ultrasound__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sdv_msgs__msg__Ultrasound__Sequence * array = (sdv_msgs__msg__Ultrasound__Sequence *)allocator.allocate(sizeof(sdv_msgs__msg__Ultrasound__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sdv_msgs__msg__Ultrasound__Sequence__init(array, size);
  if (!success) {
...
sdv_msgs__msg__Ultrasound__Sequence__destroy(sdv_msgs__msg__Ultrasound__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sdv_msgs__msg__Ultrasound__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sdv_msgs__msg__Ultrasound__Sequence__are_equal(const sdv_msgs__msg__Ultrasound__Sequence * lhs, const sdv_msgs__msg__Ultrasound__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sdv_msgs__msg__Ultrasound__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sdv_msgs__msg__Ultrasound__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sdv_msgs__msg__Ultrasound);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sdv_msgs__msg__Ultrasound * data =
      (sdv_msgs__msg__Ultrasound *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sdv_msgs__msg__Ultrasound__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sdv_msgs__msg__Ultrasound__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sdv_msgs__msg__Ultrasound__copy(
