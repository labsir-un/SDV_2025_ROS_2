...
#ifndef SDV_MSGS__MSG__DETAIL__SDV_STATUS__TYPE_SUPPORT_H_
#define SDV_MSGS__MSG__DETAIL__SDV_STATUS__TYPE_SUPPORT_H_
...
#endif  // SDV_MSGS__MSG__DETAIL__SDV_STATUS__TYPE_SUPPORT_H_
