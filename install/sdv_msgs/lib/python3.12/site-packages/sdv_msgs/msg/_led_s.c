...
bool sdv_msgs__msg__led__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_msgs.msg._led.LED", full_classname_dest, 21) == 0);
  }
  sdv_msgs__msg__LED * ros_message = _ros_message;
  {  // header
  ...
  {  // white
    PyObject * field = PyObject_GetAttrString(_pymsg, "white");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->white = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * sdv_msgs__msg__led__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_msgs.msg._led");
  ...
  {  // white
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->white);
    {
      int rc = PyObject_SetAttrString(_pymessage, "white", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
